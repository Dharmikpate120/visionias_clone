...
export default function Temp() {
  const classrooms = [
    ...
    },
    {
      ...
      onlineFees: "2, 10, 000",
      offlineFees: " 1, 40, 000",
      batchDates: ["jan 31,2025, 5:00 PM "],
    },
    {
      course: "FOUNDATION COURSE 2026",
      subtitile: "General Studies Prelims & Mains",
  ...
  return (
    <div>
      <h1 className="flex justify-center font-semibold text-4xl text-main1 my-14">
        ClassRoom
      </h1>
          ...
          {classrooms.map((rooms) => {
            return (
              <div className="flex justify-center flex-col gap-2 max-w-3xl p-6  bg-main3  shadow  dark:border-gray-300 min-h-full">
                ...
                <p className="my-3 font-normal text-light1 text-sm flex justify-center">
                  {rooms.subtitile}
                </p>
                ...
                <div className="flex justify-center gap-1">
                  ...
                  <p className="mb-3 font-normal text-light1 text-sm flex justify-center">
                    Englilsh
                  </p>
                </div>
                ...
                <div className="flex flex-col justify-center items-center">
                  <div>
                    <span className="flex text-light1 text-base font-semibold gap-1">
                      <p>Offline Fees :</p>
                ...
                <hr className="h-px mx-1 my-3 bg-main6 border-0 "></hr>

                <div>
                  <p className="flex items-center justify-center text-lg  text-light1 font-semibold">
                    Batch Dates
                  </p>
                ...
                <div className="mt-4">
                  <a
                    href="#"
                    className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-light1 bg-main1 rounded-lg hover:bg-main2 focus:outline-none"
                  >
                    Click To Register
                  </a>
                </div>
